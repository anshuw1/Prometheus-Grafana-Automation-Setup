...
PROM_LATEST_VERSION=2.53.1 

#!/bin/bash

# Construct the download URL
DOWNLOAD_URL="https://github.com/prometheus/prometheus/releases/download/${LATEST_VERSION}/prometheus-${LATEST_VERSION}.linux-amd64.tar.gz"
